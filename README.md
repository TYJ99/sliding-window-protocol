...
![](README_imgs/Aspose.Words.ec9445f7-607f-421f-b6ee-b6d723defc7e.001.png)
...
![](README_imgs/Aspose.Words.ec9445f7-607f-421f-b6ee-b6d723defc7e.002.png)
...
![](README_imgs/Aspose.Words.ec9445f7-607f-421f-b6ee-b6d723defc7e.003.png)  

1. Repeat the Step 4 for a couple of times while starting the simulator with the following command  
```
./tritontalk -s 1 -r 2 -c 0.6
```
...
![](README_imgs/Aspose.Words.ec9445f7-607f-421f-b6ee-b6d723defc7e.004.png)
...
1. **Establish Connection before Sending Actual Data:** When the sender sends its first message to a given receiver, it should first send out a frame with the **“SYN”** string (denoting SYN frame) as payload, and the receiver will reply back with a frame with **“SYN-ACK”** (denoting SYN-ACK frame) as payload. After this exchange is successful, the actual message transfer should begin. This process symbolizes a simple version of the three-way handshake. The SYN and SYN-ACK frames should be handled just like other frames:
   ...
   ![](README_imgs/Aspose.Words.ec9445f7-607f-421f-b6ee-b6d723defc7e.005.png)
...
./tritontalk -s 1 -r 2 -c 0.6  
```
will cause 60% of messages to be corrupted and thus your receiving host code logic will drop them. Your sending host should retransmit these corrupted-and-thereby-dropped frames.
...
1. If the message contents are longer than what can fit in one frame, DO NOT print each frame in a separate line. Print the consolidated message after the receiver gets all frames that contain parts of the message.
   ...
   **Example Input:**
   ...
   msg 0	1 BIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIG MESSAGE

   **Correct Output:**

   <RECV\_1>:[BIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIG MESSAGE]	✔
...
1. For testing purposes, you can create a cmd.txt file having multiple commands. Then you can use the following command to pass all commands to the tritontalk binary. 
```
cat cmd.txt | ./tritontalk -s 1 -r 2
```
